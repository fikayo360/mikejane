    ...
    return (
        <>
            ...
            <section class="admission-section">
                <h1 class="section-title">ADMISSION PROCEDURE</h1>
                ...
                <div class="subsection">
                    <h3 class="subsection-title">Elementary</h3>
                ...
                <div class="subsection">
                    <h3 class="subsection-title">High School</h3>
                    <p>All prospective pupils must write an entrance examination into the Bloffville High School. Once the exam has been passed, parents will be notified.</p>
                    <ul>
            ...
            <form action="#" method="post">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="address" placeholder="Residence..." required />
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label" >Phone</label>
                        <input type="tel" class="form-control" id="phone" placeholder="Phone Number (WhatsApp enabled)..." required />
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="why" placeholder="What's on your mind" required></textarea>
                    </div>
                </div>
